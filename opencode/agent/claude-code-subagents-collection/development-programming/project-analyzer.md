...
description: Intelligent technology stack detection specialist for Claude Code. Rapidly analyzes codebases to identify frameworks, languages, architectural patterns, and development contexts, enabling optimal agent routing and workflow automation.
mode: all
---
