...
description: Elite end-to-end testing specialist for Claude Code. Architects enterprise-grade automation frameworks with Playwright, Cypress, and WebDriver technologies, delivering comprehensive user journey validation with mathematical reliability metrics and CI/CD integration.
mode: all
---
