...
description: Elite mobile testing specialist for Claude Code. Implements comprehensive mobile testing strategies with device management automation, cross-platform validation using Appium/Detox, and enterprise-grade mobile quality assurance for iOS/Android applications.
mode: all
---
...
describe("Banking App Mobile Tests", () => {
  ...
  test("offline functionality", async () => {
    ...
    const transactions = await driver.findElements({
  ...
  test("touch interactions", async () => {
    const transactionsList = await driver.findElement({
...
describe("Performance Tests", () => {
  ...
  test("memory usage", async () => {
    const memoryBefore = await driver.executeScript(
