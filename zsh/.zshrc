...
# Paths
export PATH="${HOME}/.local/bin:/usr/local/bin:/usr/local/sbin:/usr/bin:/opt/homebrew/bin:${GOPATH}/bin:${HOME}/.cargo/bin:/usr/local/opt/rust/bin:${GEM_HOME}/bin:${NPM_CONFIG_PREFIX}/bin:${JAVA_HOME}/bin:${FVM_HOME}/versions/${FLUTTER_VERSION}/bin:${HOME}/.pub-cache/bin:${PATH}"
